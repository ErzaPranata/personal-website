...
export default function Home() {
  ...
  return (
    <SmoothScroll>
      <div className="ambient-glow min-h-screen bg-[#030303] text-zinc-100 selection:bg-brand-purple/30 relative w-full overflow-clip">
        ...
        <div className="main-wrapper">
          ...
          <section id="projects" className="project-section">
            <motion.div 
              initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant}
            ...
            <div className="project-list">
              ...
              >
                <div className="project-visual">
                  ...
                  <p className="project-caption">* Capture Project.</p>
                  
                  <div className="project-actions">
                    <a href="https://github.com/ErzaPranata/Core-API-backend-rt" target="_blank" rel="noopener noreferrer" className="btn-source">
                      <span>Codebase</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>
                    </a>
                    <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="btn-demo">
                      <span>Demo Video</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z" /></svg>
                    </a>
                  </div>
                </div>
                ...
                <div className="project-content">
                  <div>
                    ...
                    <h3 className="project-title">Backend Sistem Informasi Management RT</h3>
                  ...
                  <div className="project-tech">
                    <span className="tech-badge">NestJS</span> • <span className="tech-badge">TypeScript</span> • <span className="tech-badge">Prisma ORM</span> • <span className="tech-badge">PostgreSQL</span> • <span className="tech-badge">JWT</span> • <span className="tech-badge">Swagger UI</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="project-visual">
                  ...
                  <div className="project-actions">
                    <a href="https://github.com/ErzaPranata/Management-Store-App" target="_blank" rel="noopener noreferrer" className="btn-source">
                      <span>Codebase</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>
                    </a>
                    <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" className="btn-demo">
                ...
                <div className="project-content">
                  <div>
                    ...
                    <h3 className="project-title">Aplikasi Management Store / POS</h3>
                    <p className="project-desc">
              ...
              >
                <div className="project-visual">
                  ...
                  <div className="project-actions">
                    <a href="https://github.com/erzapranata/personal-website" target="_blank" rel="noopener noreferrer" className="btn-source">
                      <span>Codebase</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>
                    </a>
                    <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" className="btn-demo">
              ...
              >
                <div className="project-visual">
                  ...
                  <div className="project-actions">
                    <a href="https://github.com/erzapranata" target="_blank" rel="noopener noreferrer" className="btn-source">
                      <span>Codebase</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" /></svg>
                    </a>
                    <a href="https://youtube.com/" target="_blank" rel="noopener noreferrer" className="btn-demo">
                ...
                <div className="project-content">
                  <div>
                    ...
                    <h3 className="project-title">Analisa Komparatif MNB & MLR untuk Klasifikasi Hoax</h3>
                    <p className="project-desc">
              ...
              >
                <div className="project-visual">
                  ...
                  <div className="project-actions">
                    ...
                    <a href="https://github.com/erzapranata/" target="_blank" rel="noopener noreferrer" className="btn-demo">
                      <span>Live Preview</span>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
                    </a>
                  </div>
                </div>
                ...
                <div className="project-content">
                  <div>
                    ...
                    <h3 className="project-title">Pengamanan File Kriptografi Metode AES-128</h3>
                    <p className="project-desc">
          ...
          <section id="education" className="education-section">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="section-header">
              <div className="section-divider" />
            ...
            <div className="timeline-wrapper">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="timeline-item group">
                ...
                <div className="timeline-card">
                  ...
                  <div className="timeline-header">
                    <div>
                      <h3 className="timeline-title">Universitas Budi Luhur</h3>
                      <p className="timeline-desc">S1 Teknik Informatika — <span className="text-purple-400 font-medium tracking-wide">IPK 3.76 / 4.00</span></p>
                    </div>
                  ...
                  <div className="timeline-actions">
                    ...
                    <a href="https://drive.google.com" target="_blank" rel="noopener noreferrer" className="btn-outline-purple">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="timeline-item group">
                ...
                <div className="timeline-card">
                  ...
                  <div className="timeline-header">
                    <div>
                      <h3 className="timeline-title">SMAN 5 Kota Tangerang Selatan</h3>
                      <p className="timeline-desc">IPS / High School</p>
                    </div>
          ...
          <section id="experience" className="experience-section">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="experience-card group">
              ...
              <div className="exp-sidebar">
                <div>
                  <span className="exp-badge">Kuliah Kerja Nyata</span>
                  <h3 className="exp-title">Hubungan Masyarakat</h3>
                  <p className="exp-location">Desa Dangdang, Cisauk</p>
                </div>
                <span className="exp-date">Periode Tahun 2025</span>
              </div>
          ...
          <section id="skills" className="skills-section">
            ...
            <div className="skills-grid">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="skill-card skill-card-purple group">
                    ...
                    <div>
                      ...
                      <div className="skill-pill-container">
                        {['Next.js', 'React', 'Node.js', 'NestJS', 'Prisma', 'Tauri', 'Laravel', 'Tailwind'].map((skill) => (
                          <span key={skill} className="pill-purple">{skill}</span>
                        ))}
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="skill-pill-container">
                        {['PostgreSQL', 'MySQL', 'SQLite', 'Swagger'].map((skill) => (
                          <span key={skill} className="pill-neutral">{skill}</span>
                        ))}
                      </div>
                    </div>
                  </div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="skill-card skill-card-fuchsia group">
                    ...
                    <div>
                      ...
                      <div className="skill-pill-container">
                        {['Machine Learning', 'Text Mining', 'Web Scraping', 'Data Analysis'].map((skill) => (
                          <span key={skill} className="pill-fuchsia">{skill}</span>
                        ))}
                      </div>
                    </div>
                    <div>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="skill-card skill-card-violet group">
                    ...
                    <div>
                      ...
                      <div className="skill-pill-container">
                        {['Python', 'Java', 'TypeScript', 'JavaScript', 'PHP', 'HTML', 'CSS', 'C/C++'].map((skill) => (
                          <span key={skill} className="pill-violet">{skill}</span>
                        ))}
                      </div>
                    </div>
                    <div>
          ...
          <section id="contact" className="contact-section">
            ...
            <div className="contact-wrapper">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="contact-header">
              ...
              <motion.form initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} onSubmit={handleSubmitForm} className="form-container">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={fadeUpVariant} className="footer-wrapper">
